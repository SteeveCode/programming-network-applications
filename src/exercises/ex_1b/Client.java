...
public class Client {
    ...
    public Client() throws Exception {
        ...
        while(!(message.equalsIgnoreCase("EXIT"))) { // as long as the (previous) message is not "EXIT" (or "exit"), get into the loop
            ...
            String reverse = in_socket.readLine(); // receive server's response
            System.out.println("Result: " + reverse); // print server's response in console
        }
        // SOLUTION
